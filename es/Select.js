...
var Select = function (_React$Component) {
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      var _customDownArrow = customDownArrow ? React.cloneElement(customDownArrow, {
        className: prefixCls + '-arrow',
        onClick: this.onArrowClick
      }) : null;
      var _customUpArrow = customUpArrow ? React.cloneElement(customUpArrow, {
        className: prefixCls + '-arrow',
        onClick: this.onArrowClick
      }) : null;
      ...
      var rootCls = (_rootCls = {}, _defineProperty(_rootCls, className, !!className), _defineProperty(_rootCls, addClassNamesSuffix(className, '-focused'), open || !!this._focused), _defineProperty(_rootCls, addClassNamesSuffix(className, '-enabled'), !disabled), _defineProperty(_rootCls, addClassNamesSuffix(className, '-searching'), open && props.showSearch), _defineProperty(_rootCls, prefixCls, 1), _defineProperty(_rootCls, prefixCls + '-open', open), _defineProperty(_rootCls, prefixCls + '-focused', open || !!this._focused), _defineProperty(_rootCls, prefixCls + '-combobox', isCombobox(props)), _defineProperty(_rootCls, prefixCls + '-disabled', disabled), _defineProperty(_rootCls, prefixCls + '-enabled', !disabled), _defineProperty(_rootCls, prefixCls + '-allow-clear', !!props.allowClear), _rootCls);
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            _extends({
              ref: 'selection',
              key: 'selection',
              className: classnames(prefixCls + '-selection', prefixCls + '-selection--' + (multiple ? 'multiple' : 'single'), props.selectionClassName, addClassNamesSuffix(props.selectionClassName, '--' + (multiple ? 'multiple' : 'single'))),
              role: 'combobox',
            ...
            customDownArrow || multiple || !props.showArrow ? null : React.createElement(
              'span',
              _extends({
                key: 'arrow',
                className: prefixCls + '-arrow',
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getInputElement = function () {
    ...
    var inputCls = classnames(inputElement.props.className, props.searchFieldClassName, _defineProperty({}, props.prefixCls + '-search__field', true));
            return React.createElement(
      'div',
  ...
  this.updateFocusClassName = function () {
    ...
    if (_this2._focused) {
      ...
      if (props.className) {
        ...
        (_classes = classes(refs.root)).add.apply(_classes, _toConsumableArray(addClassNamesSuffix(props.className, '-focused').split(' ')));
      }
    } else {
      ...
      if (props.className) {
        ...
        (_classes2 = classes(refs.root)).remove.apply(_classes2, _toConsumableArray(addClassNamesSuffix(props.className, '-focused').split(' ')));
      }
    }
  };
  ...
  this.renderTopControlNode = function () {
    ...
    var className = classnames(prefixCls + '-selection__rendered', props.selectionRenderedClassName);
        var innerNode = null;
