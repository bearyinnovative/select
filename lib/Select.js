...
var Select = function (_React$Component) {
  ...
  (0, _createClass3['default'])(Select, [{
    ...
    value: function render() {
      ...
      var _customDownArrow = customDownArrow ? _react2['default'].cloneElement(customDownArrow, {
        className: prefixCls + '-arrow',
        onClick: this.onArrowClick
      }) : null;
      var _customUpArrow = customUpArrow ? _react2['default'].cloneElement(customUpArrow, {
        className: prefixCls + '-arrow',
        onClick: this.onArrowClick
      }) : null;
      ...
      var rootCls = (_rootCls = {}, (0, _defineProperty3['default'])(_rootCls, className, !!className), (0, _defineProperty3['default'])(_rootCls, (0, _util.addClassNamesSuffix)(className, '-focused'), open || !!this._focused), (0, _defineProperty3['default'])(_rootCls, (0, _util.addClassNamesSuffix)(className, '-enabled'), !disabled), (0, _defineProperty3['default'])(_rootCls, (0, _util.addClassNamesSuffix)(className, '-searching'), open && props.showSearch), (0, _defineProperty3['default'])(_rootCls, prefixCls, 1), (0, _defineProperty3['default'])(_rootCls, prefixCls + '-open', open), (0, _defineProperty3['default'])(_rootCls, prefixCls + '-focused', open || !!this._focused), (0, _defineProperty3['default'])(_rootCls, prefixCls + '-combobox', (0, _util.isCombobox)(props)), (0, _defineProperty3['default'])(_rootCls, prefixCls + '-disabled', disabled), (0, _defineProperty3['default'])(_rootCls, prefixCls + '-enabled', !disabled), (0, _defineProperty3['default'])(_rootCls, prefixCls + '-allow-clear', !!props.allowClear), _rootCls);
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            (0, _extends3['default'])({
              ref: 'selection',
              key: 'selection',
              className: (0, _classnames3['default'])(prefixCls + '-selection', prefixCls + '-selection--' + (multiple ? 'multiple' : 'single'), props.selectionClassName, (0, _util.addClassNamesSuffix)(props.selectionClassName, '--' + (multiple ? 'multiple' : 'single'))),
              role: 'combobox',
            ...
            customDownArrow || multiple || !props.showArrow ? null : _react2['default'].createElement(
              'span',
              (0, _extends3['default'])({
                key: 'arrow',
                className: prefixCls + '-arrow',
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getInputElement = function () {
    ...
    var inputCls = (0, _classnames3['default'])(inputElement.props.className, props.searchFieldClassName, (0, _defineProperty3['default'])({}, props.prefixCls + '-search__field', true));
  ...
  this.updateFocusClassName = function () {
    ...
    if (_this2._focused) {
      ...
      if (props.className) {
        ...
        (_classes = (0, _componentClasses2['default'])(refs.root)).add.apply(_classes, (0, _toConsumableArray3['default'])((0, _util.addClassNamesSuffix)(props.className, '-focused').split(' ')));
      }
    } else {
      ...
      if (props.className) {
        ...
        (_classes2 = (0, _componentClasses2['default'])(refs.root)).remove.apply(_classes2, (0, _toConsumableArray3['default'])((0, _util.addClassNamesSuffix)(props.className, '-focused').split(' ')));
      }
    }
  };
  ...
  this.renderTopControlNode = function () {
    ...
    var className = (0, _classnames3['default'])(prefixCls + '-selection__rendered', props.selectionRenderedClassName);
